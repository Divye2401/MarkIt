...
export default function Sidebar({
  ...
  return (
    <aside
      className={`min-h-screen bg-surface/70 ml-4 my-4 mr-2 border border-border/30 rounded-2xl flex flex-col p-4 transition-all duration-300 ease-in-out shadow-lg ${sidebarWidth}`}
